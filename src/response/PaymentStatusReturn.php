...
class PaymentStatusReturn
{
    ...
    /**
     * PaymentStatusReturn constructor.
     * @param $payment_id
     ...
     * @param $created_at
     * @param $updated_at
     * @param $outcome_amount
     * @param $outcome_currency
     */
    public function __construct($payment_id, $payment_status, $pay_address, $price_amount, $price_currency, $pay_amount, $actually_paid, $pay_currency, $order_id, $order_description, $purchase_id, $created_at, $updated_at, $outcome_amount, $outcome_currency)
    {
